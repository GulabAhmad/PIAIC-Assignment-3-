...
var person:string = " Hello Gulab Ahmad,";
...
// 2- Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase, uppercase, and titlecase.
 ...
 var person1:string = "1-Gulab Ahmad , 2-Qamar Sultan , 3-Muhammad Abdul Ahad";
...
var quote:string = "Jalal al-Din Muḥammad Rumi once said,";
...
const author:string = "Jalal al-Din Muḥammad Rumi";
const quote1:string = `"Do not be satisfied with the stories that come before you. Unfold your own myth."`;
...
const nameWithwhitespace:string = "\tGulab Ahmad\t\n";
...
var usernum:number = 5;
var usernum2:number = 3;
...
let frndNames:string[] = ["Gulab Ahmad","Qamar Sultan","Muhammad Abdul Ahad","Ghulam Ali","Umar","Asfandyar"];
...
// 10- Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
 ...
 let Greetings:string[] = ["Gulab Ahmad","Qamar Sultan","Muhammad Abdul Ahad","Ghulam Ali","Umar","Asfandyar"];
...
let transportation:string[] = ["Hayabusa", "Shikra", "Suzuki RX1000","Audi ER Tron GT"];
...
let inviteGuest:string[] = ["Gulab Ahmad","Qamar Sultan","Muhammad Abdul Ahad","Ghulam Ali","Umar","Asfandyar"];
...
const placeToVisit:string[] = ["Lahore","Karachi","Islamabad","Peshwar","Muree","Sakrdo"];
...
const myArray : number[] = [1,2,3,4,5,9,8,7,6];
...
let num1 : number = 10;
let num2 : number = 20;
let array1 : number[] = [32,56,36,90,76,56,45];
let array2 : number[] = [77,99,55,44,33,22,11,20];
...
const  favorite_fruits: string [] = ["Apple","Banana", "Oranges"];
...
const usernames : string[] = ["admin","Gulab Ahmad", "Qamar","Umar","Mukhtar Ahmad","Ali","Muhammad Abdul Ahad"];
...
function show_magicians1(magicians: string[]): void {
  ...
  const magicianNames1: string[] = ["David Copperfield", "Houdini", "Penn Jillette", "Teller"];
...
const current_users: string[] = ["Ali", "Bilal", "Ch Asad", "Dawood", "Ehtisham"];

// Make a list of new usernames
const new_users: string[] = ["Ali", "dawood", "Gulab", "Jabbar", "Dastageer"];
...
//  40 - Ordinal Numbers: Ordinal numbers indicate their position in a array, such as 1st or 2nd. Most ordinal numbers end in th, except 1, 2, and 3.
